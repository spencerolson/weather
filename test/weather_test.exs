defmodule WeatherTest do
  ...
  describe "get/1" do
    ...
    test "accepts an optional interval for the 12 hour report", context do
      ...
      assert {:ok,
              " \e[38;5;214m76°\e[0m  ⬆   \e[38;5;214m77°\e[0m  ⬇   \e[38;5;214m76°\e[0m  ⬇   \e[38;5;214m74°\e[0m  ⬇   \e[38;5;214m71°\e[0m  ⬇   \e[38;5;226m68°\e[0m  ⬇   \e[38;5;226m64°\e[0m  ⬇   \e[38;5;226m62°\e[0m  ⬇   \e[38;5;226m61°\e[0m  ⬇   \e[38;5;226m60°\e[0m  ⬇   \e[38;5;148m59°\e[0m  ⬇   \e[38;5;148m58°\e[0m  ⮕   \e[38;5;148m58°\e[0m    \n 3PM      4PM      5PM      6PM      7PM      8PM      9PM      10PM     11PM     12AM     1AM      2AM      3AM    \n\n77° | scattered clouds | 37% humidity"} =
    ...
    test "allows disabling colors", context do
      Req.Test.expect(Weather.API, fn conn ->
        conn
        |> Plug.Conn.put_resp_header("content-type", "application/json")
        |> Plug.Conn.send_resp(200, :json.encode(Clear.response()))
      ...
      assert {:ok,
              " 76°  ⬇   74°  ⬇   64°  ⬇   60°  ⬇   58°    \n 3PM      6PM      9PM      12AM     3AM    \n\n77° | scattered clouds | 37% humidity"} =
               Weather.get(%Weather.Opts{context.opts | colors: false})
    end
  end
end
